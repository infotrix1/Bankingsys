...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        #main-header:before{
            ...
            width:100%;
            height:100%;
            background-image:url('<?php echo e(asset('/img/1629334140_traffic_bg.jpg')); ?>');
            ...
            <header class="bg-dark py-5 d-flex align-items-center" id="main-header">
                <div class="container px-4 px-lg-5 my-5">
                    <div class="text-center text-white">
                        <span><img src="dist/img/dlogo.png" alt=""></span><h1 class="display-4 fw-bolder"></h1>
                        <p class="lead fw-normal text-white-50 mb-0 mt-4"><a class="btn btn-default btn-lg bg-lightblue" href='#'>Login</a></p>
                    </div>
                </div>
            </header>
            <!-- Section-->
...
<?php /**PATH C:\wamp64\www\bankingsys\resources\views/welcome.blade.php ENDPATH**/ ?>