<?php $__env->startSection('content'); ?>
        <div class="body-wrapper">
            ...
            <a href="<?php echo e(route('wallet')); ?>" class="btn  btn--success ">
            ...
            <div class="float-right" style="width: 180px; height: 180px;" >
                    <div class="widget-three box--shadow2 b-radius--5 bg--success text-white" style="padding: 15px;">
                        <div class="widget-three__content">
                            <h2><?php echo e($data->wallent_amount); ?></h2>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\bankingsys\resources\views/home.blade.php ENDPATH**/ ?>